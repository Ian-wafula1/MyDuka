    ...
    def post(self):
        try: 
            ...
            if account_type == 'merchant':
                ...
                user = User.query.filter_by(email=request.json['email'], account_type='admin').first()
            
            elif account_type == 'clerk':
                user = User.query.filter_by(email=request.json['email'], account_type='clerk').first()
            else:
