...
import MyTextInput from '../utils/formElements/MyTextInput';
      ...
      {showInviteForm && (
        <div className="invite-form-section">
          ...
          <p className="invite-description">
            Send an invitation email with a secure token that expires in 7 days.
          </p>
          <Formik
            initialValues={{ email: '' }}
        ...
        <div className="admins-header">
          ...
          <div className="admin-stats">
            <span className="stat-item">
              Active: {admins.filter(a => a.account_status === 'active').length}
            </span>
            <span className="stat-item">
              Inactive: {admins.filter(a => a.account_status === 'inactive').length}
            </span>
          </div>
        </div>
                ...
                <div className="admin-info">
                  ...
                  <div className="admin-header">
                    ...
                    <div className="admin-basic-info">
                      ...
                      <span className={getStatusBadgeClass(admin.account_status)}>
                    ...
                    <div className="admin-performance">
                      ...
                      <div className="performance-grid">
                        <div className="performance-item">
                          ...
                          <span className="perf-value text-green-600">
                            {admin.performance.requests_approved}
                          </span>
                        </div>
                        <div className="performance-item">
                          <span className="perf-label">Declined</span>
                          <span className="perf-value text-red-600">
                            {admin.performance.requests_declined}
                          </span>
                        </div>
                        <div className="performance-item">
                          <span className="perf-label">Response Time</span>
                          <span className="perf-value">
                            {admin.performance.avg_response_time}
                          </span>
                        </div>
                        <div className="performance-item">
                          <span className="perf-label">Clerks Managed</span>
                          <span className="perf-value">
                            {admin.performance.clerks_managed}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="admin-actions">
                  <button
                    className={`btn-status ${
                      admin.account_status === 'active' ? 'btn-deactivate' : 'btn-activate'
                    }`}
                    onClick={() =>
                      onStatusChange(
                        admin.id,
                        admin.account_status === 'active' ? 'inactive' : 'active'
                      )
                    }
                  >
